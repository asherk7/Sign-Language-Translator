...
def plot_training_curves(results):
    ...
    plt.tight_layout()
    os.makedirs('/content/Sign-Language-Translator/eda/images', exist_ok=True)
    plt.savefig('/content/Sign-Language-Translator/eda/images/training_graph.png')
    print("Training curves saved to /content/Sign-Language-Translator/eda/images/training_graph.png")
...
def get_matrix(y_pred, y_true, classes):
    ...
    plt.tight_layout()
    os.makedirs('/content/Sign-Language-Translator/eda/images', exist_ok=True)
    plt.savefig('/content/Sign-Language-Translator/eda/images/confusion_matrix.png')
    print("Confusion matrix saved to /content/Sign-Language-Translator/eda/images/confusion_matrix.png")
